...
public partial class Signup
{
    public class Request
    {
        ...
        public Request(string player_name, string savedata, string passcode, int kind)
        {
    ...
    public static Util.Future<Response> Post(global::Api.Net.Requests requests, Request request)
    {
        ...
        return requests.Send(global::Api.Net.Requests.BASE_URL + "/api/player/signup", HTTPMethods.Post, Encoding.UTF8.GetBytes(postStr)).Then(buf =>
        {
#if false
