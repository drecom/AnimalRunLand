...
public struct BuildingData : IFlatbufferObject
{
    ...
    public Position ? ExteriorPositions(int j)
    {
        int o = __p.__offset(6);
        return o != 0 ? (Position ?)(new Position()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null;
    }
    public int ExteriorPositionsLength
    {
        get
        {
            int o = __p.__offset(6);
    ...
    public static Offset<BuildingData> CreateBuildingData(FlatBufferBuilder builder,
            StringOffset IdOffset = default(StringOffset),
            VectorOffset ExteriorPositionsOffset = default(VectorOffset),
            Offset<StringDictionary> InfoOffset = default(Offset<StringDictionary>))
    {
        builder.StartObject(3);
        BuildingData.AddInfo(builder, InfoOffset);
        BuildingData.AddExteriorPositions(builder, ExteriorPositionsOffset);
        BuildingData.AddId(builder, IdOffset);
        return BuildingData.EndBuildingData(builder);
    }
    ...
    public static void AddExteriorPositions(FlatBufferBuilder builder, VectorOffset ExteriorPositionsOffset)
    {
        builder.AddOffset(1, ExteriorPositionsOffset.Value, 0);
    }
    public static VectorOffset CreateExteriorPositionsVector(FlatBufferBuilder builder, Offset<Position>[] data)
    {
    ...
    public static void StartExteriorPositionsVector(FlatBufferBuilder builder, int numElems)
    {
