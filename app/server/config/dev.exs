...
config :firestorm_server, FirestormServerWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r{priv/gettext/.*(po)$},
      ~r{lib/firestorm_server_web/views/.*(ex)$},
      ~r{lib/firestorm_server_web/templates/.*(eex)$}
    ]
  ]
...
# Configure firestorm_server commu use crypto
# You must change config of "ex_tool" to match it!!
